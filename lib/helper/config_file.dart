...
enum AppFlavor { student, teacher, parent }

class AppConfig {
  static  AppFlavor appFlavor = AppFlavor.student;
}

AppFlavor getAppFlavor(String appType) {
  switch (appType) {
    case 'student':
      return AppFlavor.student;
    case 'teacher':
      return AppFlavor.teacher;
    case 'parent':
      return AppFlavor.parent;
    default:
      return AppFlavor.student;
  }
}
...
bool isStudent() {
  return AppConfig.appFlavor == AppFlavor.student;
}
bool isTeacher() {
  return AppConfig.appFlavor == AppFlavor.teacher;
}
bool isParent() {
  return AppConfig.appFlavor == AppFlavor.parent;
}
